...
public class OrderMgtClient {
    ...
    private static void invokeOrderUpdate(OrderManagementGrpc.OrderManagementStub asyncStub) {
        ...
        OrderManagementOuterClass.Order upOrder1 = OrderManagementOuterClass.Order.newBuilder()
                .setId("102")
                .addItems("Google Pixel 3A").addItems("Google Pixel Book")
                .setDestination("Mountain View, CA")
                .setPrice(1100)
                .build();
        OrderManagementOuterClass.Order upOrder2 = OrderManagementOuterClass.Order.newBuilder()
                .setId("103")
                .addItems("Apple Watch S4").addItems("Mac Book pro").addItems("iPad Pro")
                .setDestination("Mountain View, CA")
                .setPrice(2800)
                .build();
        OrderManagementOuterClass.Order upOrder3 = OrderManagementOuterClass.Order.newBuilder()
                .setId("104")
        ...
        updateOrderRequestObserver.onNext(upOrder1);
        updateOrderRequestObserver.onNext(upOrder2);
        updateOrderRequestObserver.onNext(upOrder3);
        updateOrderRequestObserver.onNext(upOrder3);
